    ...
    <div id="bg">
        <div class="login-box">
            ...
            <form method="post">
                ...
                <div class="fp1">
                    <span>Back to</span><a href="myaccount.php"> My Account</a>
                </div>
    ...
    if ($_POST) {
        ...
        if ($uname === $username) {
            ...
            if ($newpass === $conpass) {
                ...
                $sql = "UPDATE `MyGuests` SET `cpassword` = '$newpass' WHERE `MyGuests`.`username` = '$username';";

                $result = mysqli_query($conn, $sql);
                // $num = mysqli_num_rows($result);
    
                echo "<script>";
                echo "location.replace('myaccount.php')";
                echo "</script>";
            ...
            echo "<script>alert('Enter your correct username.')</script>";
        }
    }
    ?>
</body>
